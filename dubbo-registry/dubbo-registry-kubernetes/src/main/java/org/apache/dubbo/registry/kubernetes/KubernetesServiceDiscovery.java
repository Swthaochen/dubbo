...
public class KubernetesServiceDiscovery extends AbstractServiceDiscovery {
    ...
    public void doInitialize(URL registryURL) throws Exception {
        Config config = KubernetesConfigUtils.testK8sInitConfig(registryURL.getAddress());
...
//        this.currentHostname = "dubboapi-7fb4cb859b-smw9x";
        ...
        try {
            availableAccess = kubernetesClient.pods().inNamespace(this.namespace).withName(currentHostname).get() != null;
        } catch (Throwable e) {
